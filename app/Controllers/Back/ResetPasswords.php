...
use App\Models\Back\ResetPassword;
...
class ResetPasswords 
{
    ...
    public function sendEmail(){
        ...
        $url = 'http://localhost/udemy/projets/serveurFSmyZoo/views/login/create-new-password.php?selector='.$selector.'&validator='.bin2hex($token);
        ...
        $this->mail->setFrom('login@myzoo.com');
